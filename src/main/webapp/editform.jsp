...
<table>
	<tr><td>Image:</td><td><input type="file" name="photo" value="${vo.getPhoto()}"/></td></tr>

	<tr><td><c:if test="${vo.getPhoto() ne ''}"><img src="${pageContext.request.contextPath }/upload/${vo.getPhoto()}" class="photo"></c:if></td></tr>
	<tr><td>Category:</td><td><input type="category" name="category" value="${vo.getCategory()}"/></td></tr>
